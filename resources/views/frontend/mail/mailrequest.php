...
<body>
    <div style="padding-left: 10%; padding-right: 10%;">
        ...
        <h4>Your request for the <a href="<?= $product_link ?>">product</a> has been submitted successfully and it is pending for approval. <br> You will be notified by email again once approved. The details are as follows - </h4><br>
